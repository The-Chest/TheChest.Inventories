...
namespace TheChest.Inventories.Tests.Common.Extensions.Containers
{
    public static class IStackContainerExtensions
    {
        ...
        public static IStackSlot<T>[] GetSlots<T>(this IStackContainer<T> container) => container.GetSlotsField() as IStackSlot<T>[];
        /// <summary>
        ...
        public static IStackSlot<T> GetSlot<T>(this IStackContainer<T> container, int index) => container.GetSlots<T>()[index];
        /// <summary>
        ...
        public static T[] GetItems<T>(this IStackContainer<T> container, int index) => container.GetSlot<T>(index).GetContents<T>();
    }
}
